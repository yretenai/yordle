...
yordle::data::meta::VfxPrimitiveTrailBase::VfxPrimitiveTrailBase(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::VfxPrimitiveBase(prop) {
    if(prop == nullptr) {
        return;
    }

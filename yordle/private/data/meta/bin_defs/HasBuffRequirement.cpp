...
yordle::data::meta::HasBuffRequirement::HasBuffRequirement(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::ISpellRankUpRequirement(prop) {
    if(prop == nullptr) {
        return;
    }

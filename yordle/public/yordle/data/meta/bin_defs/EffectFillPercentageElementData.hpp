...
#ifndef YORDLE_META_DEF_EffectFillPercentageElementData
#pragma once
...
namespace yordle::data::meta {
    ...
    struct AtlasData;
#endif
    struct YORDLE_EXPORT EffectFillPercentageElementData : public EffectElementData {
        explicit EffectFillPercentageElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 220339975u || EffectElementData::is_type(type);
        }
...
#define YORDLE_META_DEF_EffectFillPercentageElementData
#endif

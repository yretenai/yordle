...
#ifndef YORDLE_META_DEF_OptionTemplateCheckbox
#pragma once
...
namespace yordle::data::meta {
    struct YORDLE_EXPORT OptionTemplateCheckbox : public IOptionTemplate {
        explicit OptionTemplateCheckbox(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 2855504619u || IOptionTemplate::is_type(type);
        }
...
#define YORDLE_META_DEF_OptionTemplateCheckbox
#endif

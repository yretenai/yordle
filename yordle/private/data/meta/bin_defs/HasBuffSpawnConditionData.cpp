...
yordle::data::meta::HasBuffSpawnConditionData::HasBuffSpawnConditionData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::VFXSpawnConditionData(prop) {
    if(prop == nullptr) {
        return;
    }

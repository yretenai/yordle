...
yordle::data::meta::x17e5a283::x17e5a283(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    auto ptr_xaaf62a62 = prop->cast_prop<yordle::data::prop::inline_structure_prop>(2868259426u);
    if(ptr_xaaf62a62 != nullptr) {
        xaaf62a62 = yordle::data::meta::deserialize<yordle::data::meta::x137c5cb3>(ptr_xaaf62a62, 326917299u);
    }
}

...
namespace yordle::data::meta {
    struct YORDLE_EXPORT VFXDefaultSpawnConditionData : public VFXSpawnConditionData {
        explicit VFXDefaultSpawnConditionData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 922712184u || VFXSpawnConditionData::is_type(type);
        }
    };
}
#define YORDLE_META_DEF_VFXDefaultSpawnConditionData
#endif

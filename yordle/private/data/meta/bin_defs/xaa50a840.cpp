...
yordle::data::meta::xaa50a840::xaa50a840(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    auto ptr_category = prop->cast_prop<yordle::data::prop::uint8_prop>(3475980913u);

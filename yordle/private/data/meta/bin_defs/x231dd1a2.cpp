...
yordle::data::meta::x231dd1a2::x231dd1a2(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_mScene != nullptr) {
        mScene = yordle::data::meta::bin_ref<yordle::data::meta::SceneData>(2867346523u, ptr_mScene->value);
    }
}

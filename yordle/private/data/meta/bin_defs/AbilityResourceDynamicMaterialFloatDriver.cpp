...
yordle::data::meta::AbilityResourceDynamicMaterialFloatDriver::AbilityResourceDynamicMaterialFloatDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IDynamicMaterialFloatDriver(prop) {
    if(prop == nullptr) {
        return;
    }

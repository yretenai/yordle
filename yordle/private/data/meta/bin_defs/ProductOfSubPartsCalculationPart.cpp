...
yordle::data::meta::ProductOfSubPartsCalculationPart::ProductOfSubPartsCalculationPart(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IGameCalculationPart(prop) {
    if(prop == nullptr) {
        return;
    }

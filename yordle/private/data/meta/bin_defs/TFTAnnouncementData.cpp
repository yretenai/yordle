...
yordle::data::meta::TFTAnnouncementData::TFTAnnouncementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    auto ptr_x8b7d190d = prop->cast_prop<yordle::data::prop::fnv_hash_prop>(2340231437u);
    if(ptr_x8b7d190d != nullptr) {
        x8b7d190d = ptr_x8b7d190d->value;
    }

...
yordle::data::meta::EffectDesaturateElementData::EffectDesaturateElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::EffectElementData(prop) {
    if(prop == nullptr) {
        return;
    }

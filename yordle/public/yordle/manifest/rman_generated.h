...
#ifndef FLATBUFFERS_GENERATED_RMAN_yordle_MANIFEST_GENERATED_H_
#define FLATBUFFERS_GENERATED_RMAN_yordle_MANIFEST_GENERATED_H_
...
struct rman FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>> *chunks() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>> *>(VT_CHUNKS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>> *languages() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>> *>(VT_LANGUAGES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>> *files() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>> *>(VT_FILES);
  }
  const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>> *directories() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>> *>(VT_DIRECTORIES);
  }
...
struct rmanBuilder {
  ...
  void add_chunks(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>>> chunks) {
    fbb_.AddOffset(rman::VT_CHUNKS, chunks);
  }
  void add_languages(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>>> languages) {
    fbb_.AddOffset(rman::VT_LANGUAGES, languages);
  }
  void add_files(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>>> files) {
    fbb_.AddOffset(rman::VT_FILES, files);
  }
  void add_directories(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>>> directories) {
...
inline flatbuffers::Offset<rman> Createrman(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>>> chunks = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>>> languages = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>>> files = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>>> directories = 0,
...
inline flatbuffers::Offset<rman> CreatermanDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>> *chunks = nullptr,
    const std::vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>> *languages = nullptr,
    const std::vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>> *files = nullptr,
    const std::vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>> *directories = nullptr,
    const char *unknown1 = nullptr,
    const std::vector<uint32_t> *unknown2 = nullptr) {
  auto chunks__ = chunks ? _fbb.CreateVector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_chunk>>(*chunks) : 0;
  auto languages__ = languages ? _fbb.CreateVector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_language>>(*languages) : 0;
  auto files__ = files ? _fbb.CreateVector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_file>>(*files) : 0;
  auto directories__ = directories ? _fbb.CreateVector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_directory>>(*directories) : 0;
  auto unknown1__ = unknown1 ? _fbb.CreateString(unknown1) : 0;
  auto unknown2__ = unknown2 ? _fbb.CreateVector<uint32_t>(*unknown2) : 0;
  return yordle::manifest::generated::Createrman(
      _fbb,
      chunks__,
      languages__,
      files__,
...
struct riot_manifest_chunk FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>> *blocks() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>> *>(VT_BLOCKS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct riot_manifest_chunkBuilder {
  ...
  void add_blocks(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>>> blocks) {
...
inline flatbuffers::Offset<riot_manifest_chunk> Createriot_manifest_chunk(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t chunk_id = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>>> blocks = 0) {
...
inline flatbuffers::Offset<riot_manifest_chunk> Createriot_manifest_chunkDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t chunk_id = 0,
    const std::vector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>> *blocks = nullptr) {
  auto blocks__ = blocks ? _fbb.CreateVector<flatbuffers::Offset<yordle::manifest::generated::riot_manifest_block>>(*blocks) : 0;
  return yordle::manifest::generated::Createriot_manifest_chunk(
      _fbb,
      chunk_id,
      blocks__);
}
...
inline flatbuffers::Offset<riot_manifest_language> Createriot_manifest_languageDirect(
  ...
  return yordle::manifest::generated::Createriot_manifest_language(
      _fbb,
      language_id,
      name__);
}
...
inline flatbuffers::Offset<riot_manifest_file> Createriot_manifest_fileDirect(
  ...
  return yordle::manifest::generated::Createriot_manifest_file(
      _fbb,
      file_id,
      directory_id,
      size,
...
inline flatbuffers::Offset<riot_manifest_directory> Createriot_manifest_directoryDirect(
    ...
    const char *name = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return yordle::manifest::generated::Createriot_manifest_directory(
      _fbb,
      id,
      parent_id,
      name__);
...
inline const yordle::manifest::generated::rman *Getrman(const void *buf) {
  return flatbuffers::GetRoot<yordle::manifest::generated::rman>(buf);
}

inline const yordle::manifest::generated::rman *GetSizePrefixedrman(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<yordle::manifest::generated::rman>(buf);
}

inline bool VerifyrmanBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<yordle::manifest::generated::rman>(nullptr);
}

inline bool VerifySizePrefixedrmanBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<yordle::manifest::generated::rman>(nullptr);
}

inline void FinishrmanBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<yordle::manifest::generated::rman> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_RMAN_yordle_MANIFEST_GENERATED_H_

...
yordle::data::meta::HasUnitTagsCastRequirement::HasUnitTagsCastRequirement(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::ICastRequirement(prop) {
    if(prop == nullptr) {
        return;
    }

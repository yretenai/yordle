...
yordle::data::meta::TargetTypeFilter::TargetTypeFilter(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IStatStoneLogicDriver(prop) {
    if(prop == nullptr) {
        return;
    }

...
yordle::data::meta::VectorTableGet::VectorTableGet(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IVectorGet(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_Default != nullptr) {
        auto ptr_Default_opt = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::vector_prop>(ptr_Default->value);
        if (ptr_Default_opt != nullptr) {
            Default = ptr_Default_opt->value;
        }
    }
}

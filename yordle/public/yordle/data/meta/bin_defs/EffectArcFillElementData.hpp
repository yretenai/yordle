...
#ifndef YORDLE_META_DEF_EffectArcFillElementData
#pragma once
...
namespace yordle::data::meta {
    ...
    struct AtlasData;
#endif
    struct YORDLE_EXPORT EffectArcFillElementData : public EffectElementData {
        explicit EffectArcFillElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 2608359503u || EffectElementData::is_type(type);
        }
...
#define YORDLE_META_DEF_EffectArcFillElementData
#endif

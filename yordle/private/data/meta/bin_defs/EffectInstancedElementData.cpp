...
yordle::data::meta::EffectInstancedElementData::EffectInstancedElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::EffectElementData(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    auto ptr_x71254c3b = prop->cast_prop<yordle::data::prop::set_prop>(1898269755u);
    if(ptr_x71254c3b != nullptr) {
        for(const auto &set_x71254c3b_entry : ptr_x71254c3b->value) {
            auto ptr_x71254c3b_entry = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::point_prop>(set_x71254c3b_entry);
            if(ptr_x71254c3b_entry != nullptr) {
                x71254c3b.emplace_back(ptr_x71254c3b_entry->value);
            }
        }
    }
}

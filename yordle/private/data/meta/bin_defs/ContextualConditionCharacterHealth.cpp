...
yordle::data::meta::ContextualConditionCharacterHealth::ContextualConditionCharacterHealth(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::ICharacterSubcondition(prop) {
    if(prop == nullptr) {
        return;
    }

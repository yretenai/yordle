...
yordle::data::meta::MaterialInstanceParamDef::MaterialInstanceParamDef(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }

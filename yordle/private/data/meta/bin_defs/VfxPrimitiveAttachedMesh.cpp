...
yordle::data::meta::VfxPrimitiveAttachedMesh::VfxPrimitiveAttachedMesh(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::VfxPrimitiveMeshBase(prop) {
    if(prop == nullptr) {
        return;
    }

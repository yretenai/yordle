...
yordle::data::meta::ContextualConditionSpellSlot::ContextualConditionSpellSlot(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IContextualConditionSpell(prop) {
    if(prop == nullptr) {
        return;
    }

...
namespace yordle::data::meta {
    ...
    struct YORDLE_EXPORT ItemData : public bin_class {
        ...
        float mFlatCooldownMod = 0.0f;
        float mPercentCooldownMod = 0.0f;
        float mAbilityHasteMod = 0.0f;
        float mFlatHPPoolMod = 0.0f;
        float mPercentHPPoolMod = 0.0f;
        float mFlatHPRegenMod = 0.0f;
        float mPercentHPRegenMod = 0.0f;
        float mPercentBaseHPRegenMod = 0.0f;
        float mPercentTenacityItemMod = 0.0f;
        float mPercentSlowResistMod = 0.0f;
        float mFlatMovementSpeedMod = 0.0f;
        float mPercentMovementSpeedMod = 0.0f;
        float mPercentMultiplicativeMovementSpeedMod = 0.0f;
        float mFlatArmorMod = 0.0f;
        float mPercentArmorMod = 0.0f;
        float mFlatArmorPenetrationMod = 0.0f;
        float mPercentArmorPenetrationMod = 0.0f;
        float mPercentBonusArmorPenetrationMod = 0.0f;
        float mFlatMagicPenetrationMod = 0.0f;
        float mPercentMagicPenetrationMod = 0.0f;
        float mPercentBonusMagicPenetrationMod = 0.0f;
        float mFlatSpellBlockMod = 0.0f;
        float mPercentSpellBlockMod = 0.0f;
        float mFlatDodgeMod = 0.0f;
        float mFlatCritChanceMod = 0.0f;
        float mFlatMissChanceMod = 0.0f;
        float mFlatCritDamageMod = 0.0f;
        float mPercentCritDamageMod = 0.0f;
        float mFlatPhysicalDamageMod = 0.0f;
        float mPercentPhysicalDamageMod = 0.0f;
        float mFlatMagicDamageMod = 0.0f;
        float mPercentMagicDamageMod = 0.0f;
        float mFlatPhysicalReduction = 0.0f;
        float mPercentPhysicalReduction = 0.0f;
        float mFlatMagicReduction = 0.0f;
        float mPercentMagicReduction = 0.0f;
        float mPercentEXPBonus = 0.0f;
        float mFlatAttackRangeMod = 0.0f;
        float mPercentAttackRangeMod = 0.0f;
        float mFlatCastRangeMod = 0.0f;
        float mPercentCastRangeMod = 0.0f;
        float mPercentAttackSpeedMod = 0.0f;
        float mPercentMultiplicativeAttackSpeedMod = 0.0f;
        float mPercentHealingAmountMod = 0.0f;
        float mPercentLifeStealMod = 0.0f;
        float mPercentSpellVampMod = 0.0f;
        float PercentOmniVampMod = 0.0f;
        float PercentPhysicalVampMod = 0.0f;
        float mPercentSpellEffectivenessMod = 0.0f;
        float mFlatBubbleRadiusMod = 0.0f;
        float mPercentBubbleRadiusMod = 0.0f;
        float sellBackModifier = 0.699999988079071f;
        float mCooldownShowDisabledDuration = 0.0f;
        float flatMPPoolMod = 0.0f;
        float PercentMPPoolMod = 0.0f;
        float flatMPRegenMod = 0.0f;
        float PercentMPRegenMod = 0.0f;
        float percentBaseMPRegenMod = 0.0f;

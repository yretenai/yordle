...
yordle::data::meta::xfdad6e32::xfdad6e32(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_xdbc0caa0 != nullptr) {
        ...
        for(const auto &set_xdbc0caa0_entry : ptr_xdbc0caa0->value) {
            ...
            if(ptr_xdbc0caa0_entry != nullptr) {
                xdbc0caa0[index_xdbc0caa0] = ptr_xdbc0caa0_entry->value;
            }
            index_xdbc0caa0++;
        }
    }

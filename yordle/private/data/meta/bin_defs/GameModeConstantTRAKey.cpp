...
yordle::data::meta::GameModeConstantTRAKey::GameModeConstantTRAKey(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::GameModeConstant(prop) {
    if(prop == nullptr) {
        return;
    }

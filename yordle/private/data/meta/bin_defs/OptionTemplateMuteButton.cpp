...
yordle::data::meta::OptionTemplateMuteButton::OptionTemplateMuteButton(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IOptionTemplate(prop) {
    if(prop == nullptr) {
        return;
    }

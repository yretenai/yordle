...
yordle::data::meta::OneTrueMaterialDriver::OneTrueMaterialDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IDynamicMaterialBoolDriver(prop) {
    if(prop == nullptr) {
        return;
    }

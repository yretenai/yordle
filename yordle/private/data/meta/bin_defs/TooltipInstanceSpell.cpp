...
yordle::data::meta::TooltipInstanceSpell::TooltipInstanceSpell(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::TooltipInstance(prop) {
    if(prop == nullptr) {
        return;
    }

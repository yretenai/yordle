...
yordle::data::meta::x7a2da7e3::x7a2da7e3(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    auto ptr_x2065d503 = prop->cast_prop<yordle::data::prop::fnv_hash_prop>(543544579u);
    if(ptr_x2065d503 != nullptr) {
        x2065d503 = ptr_x2065d503->value;
    }

...
yordle::data::meta::VfxSineMaterialDriver::VfxSineMaterialDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IVfxMaterialDriver(prop) {
    if(prop == nullptr) {
        return;
    }

...
namespace yordle::data::meta {
    struct YORDLE_EXPORT RegionElementData : public BaseElementData {
        explicit RegionElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 1859523703u || BaseElementData::is_type(type);
        }
    };
}
#define YORDLE_META_DEF_RegionElementData
#endif

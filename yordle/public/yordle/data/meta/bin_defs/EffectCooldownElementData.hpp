...
#ifndef YORDLE_META_DEF_EffectCooldownElementData
#pragma once
...
namespace yordle::data::meta {
    struct YORDLE_EXPORT EffectCooldownElementData : public EffectElementData {
        explicit EffectCooldownElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3191832311u || EffectElementData::is_type(type);
        }
...
#define YORDLE_META_DEF_EffectCooldownElementData
#endif

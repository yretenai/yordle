...
yordle::data::meta::FloatTableGet::FloatTableGet(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IFloatGet(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_Default != nullptr) {
        auto ptr_Default_opt = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::float32_prop>(ptr_Default->value);

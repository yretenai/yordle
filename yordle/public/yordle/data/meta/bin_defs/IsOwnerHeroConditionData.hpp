...
namespace yordle::data::meta {
    struct YORDLE_EXPORT IsOwnerHeroConditionData : public VFXSpawnConditionData {
        explicit IsOwnerHeroConditionData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3706207649u || VFXSpawnConditionData::is_type(type);
        }
    };
}
#define YORDLE_META_DEF_IsOwnerHeroConditionData
#endif

...
#endif
    struct YORDLE_EXPORT OverrideAutoAttackCastTimeData : public bin_class {
        explicit OverrideAutoAttackCastTimeData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3397751176u;
        }

        std::shared_ptr<yordle::data::meta::IGameCalculation> mOverrideAutoattackCastTimeCalculation {};
    };
}
#define YORDLE_META_DEF_OverrideAutoAttackCastTimeData
#endif

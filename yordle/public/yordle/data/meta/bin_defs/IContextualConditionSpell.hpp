...
namespace yordle::data::meta {
    struct YORDLE_EXPORT IContextualConditionSpell : public IContextualCondition {
        explicit IContextualConditionSpell(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 576452982u || IContextualCondition::is_type(type);
        }
    };
}
#define YORDLE_META_DEF_IContextualConditionSpell
#endif

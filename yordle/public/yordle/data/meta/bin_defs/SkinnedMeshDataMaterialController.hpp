...
namespace yordle::data::meta {
    struct YORDLE_EXPORT SkinnedMeshDataMaterialController : public bin_class {
        explicit SkinnedMeshDataMaterialController(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3460011047u;
        }
    };
}
#define YORDLE_META_DEF_SkinnedMeshDataMaterialController
#endif

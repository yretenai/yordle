...
yordle::data::meta::ContextualConditionMoveDistance::ContextualConditionMoveDistance(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IContextualCondition(prop) {
    if(prop == nullptr) {
        return;
    }

...
yordle::data::meta::VfxAnimatedVector3fVariableData::VfxAnimatedVector3fVariableData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_values != nullptr) {
        for(const auto &set_values_entry : ptr_values->value) {
            auto ptr_values_entry = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::vector_prop>(set_values_entry);

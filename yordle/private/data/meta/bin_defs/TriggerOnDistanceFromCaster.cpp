...
yordle::data::meta::TriggerOnDistanceFromCaster::TriggerOnDistanceFromCaster(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::MissileTriggerSpec(prop) {
    if(prop == nullptr) {
        return;
    }

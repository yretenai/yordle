...
yordle::data::meta::SpecificColorMaterialDriver::SpecificColorMaterialDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IDynamicMaterialDriver(prop) {
    if(prop == nullptr) {
        return;
    }

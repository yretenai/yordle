...
#ifndef YORDLE_META_DEF_HasNNearbyUnitsRequirement
#pragma once
...
#endif
    struct YORDLE_EXPORT HasNNearbyUnitsRequirement : public ICastRequirement {
        explicit HasNNearbyUnitsRequirement(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 1987560042u || ICastRequirement::is_type(type);
        }
...
#define YORDLE_META_DEF_HasNNearbyUnitsRequirement
#endif

...
";
    ...
    // language=c++
    public const string BIN_DISPATCH_ENTRY = @"    table[%{HASH}u] = [](prop_arg prop) { return make_shared<yordle::data::meta::%{NAME}>(prop); };";
...
auto ptr_%{NAME} = prop->cast_prop<%{TYPE}>(%{HASH}u);
...
";
    ...
    // language=c++
    public const string BIN_CLASS_IMPL_VALUE_SUB_LOGIC_EMBED = @"yordle::data::meta::bin_ref<yordle::data::meta::%{CLASS}>(%{HASH}u, ptr_%{NAME}.value)";

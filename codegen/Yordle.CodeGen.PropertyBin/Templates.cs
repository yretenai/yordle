...
";
    ...
    // language=c++
    public const string BIN_DISPATCH_ENTRY = @"    table[%{HASH}u] = [](prop_arg prop) { return reinterpret_pointer_cast<yordle::data::meta::bin_class>(make_shared<yordle::data::meta::%{NAME}>(prop)); };";

    // language=c++
    public const string BIN_CLASS_DEF_MAIN = @"/// <auto-generated>
// THIS FILE IS AUTO GENERATED DO NOT EDIT
#ifndef YORDLE_META_DEF_%{NAME}
#pragma once
...
%{CLASS_REF}
    struct YORDLE_EXPORT %{NAME} : %{BASE_CLASS} {
        ...
        bool is_type(uint32_t type) override {
            return type == %{HASH}u%{TYPE_CHECK};
        }

%{PROPERTIES}
    };
}
#define YORDLE_META_DEF_%{NAME}
#endif
";
    ...
    // language=c++
    public const string BIN_CLASS_DEF_CLASS_REF = @"
#ifndef YORDLE_META_DEF_%{REF}
    struct %{REF};
#endif";
...
";
    ...
    auto ptr_%{NAME} = prop->cast_prop<yordle::data::prop::%{TYPE}>(%{HASH}u);
    if(ptr_%{NAME} != nullptr) {
        %{NAME} = %{SUB_LOGIC};
    }
";
    // language=c++
    public const string BIN_CLASS_IMPL_RAW_VALUE = @"
    auto ptr_%{NAME} = prop->cast_prop<yordle::data::prop::%{TYPE}>(%{HASH}u);
    if(ptr_%{NAME} != nullptr) {
        %{SUB_LOGIC}
    }
";
    ...
    // language=c++
    public const string BIN_CLASS_IMPL_VALUE_SUB_LOGIC_POINTER = @"yordle::data::meta::deserialize<yordle::data::meta::%{CLASS}>(ptr_%{NAME}, %{HASH}u)";

    // language=c++
    public const string BIN_CLASS_IMPL_VALUE_SUB_LOGIC_LINK= @"yordle::data::meta::bin_ref<yordle::data::meta::%{CLASS}>(%{HASH}u, ptr_%{NAME}->value)";

    // language=c++
    public const string BIN_CLASS_IMPL_VALUE_SUB_LOGIC_OPTIONAL = @"auto ptr_%{NAME}_opt = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::%{VALUE_TYPE}>(ptr_%{NAME}->value);
...
";
    ...
    if(ptr_%{NAME} != nullptr) {
        for(const auto &set_%{NAME}_entry : ptr_%{NAME}->value) {
            auto ptr_%{NAME}_entry = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::%{VALUE_TYPE}>(set_%{NAME}_entry);
...
";
    ...
    if(ptr_%{NAME} != nullptr) {
        for(const auto &set_%{NAME}_pair : ptr_%{NAME}->value) {
            auto ptr_%{NAME}_key = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::%{KEY_TYPE}>(set_%{NAME}_pair.first);
            auto ptr_%{NAME}_value = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::%{VALUE_TYPE}>(set_%{NAME}_pair.second);
...
";
    ...
    public const string CMAKE_DEFINE = @"### <auto-generated>
# THIS FILE IS AUTO GENERATED DO NOT EDIT
project(yordle_data_meta_bin_defs)

target_sources(yordle PRIVATE 
%{NAMES})
";

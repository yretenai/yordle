...
yordle::data::meta::GoldSourceFilter::GoldSourceFilter(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IStatStoneLogicDriver(prop) {
    if(prop == nullptr) {
        return;
    }

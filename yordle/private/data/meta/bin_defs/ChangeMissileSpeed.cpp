...
yordle::data::meta::ChangeMissileSpeed::ChangeMissileSpeed(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::MissileTriggeredActionSpec(prop) {
    if(prop == nullptr) {
        return;
    }

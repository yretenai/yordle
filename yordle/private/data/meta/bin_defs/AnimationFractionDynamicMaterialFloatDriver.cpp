...
yordle::data::meta::AnimationFractionDynamicMaterialFloatDriver::AnimationFractionDynamicMaterialFloatDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::xb33b2406(prop) {
    if(prop == nullptr) {
        return;
    }

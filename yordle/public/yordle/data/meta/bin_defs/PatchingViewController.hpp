...
#ifndef YORDLE_META_DEF_PatchingViewController
#pragma once
...
namespace yordle::data::meta {
    struct YORDLE_EXPORT PatchingViewController : public ViewController {
        explicit PatchingViewController(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 161679594u || ViewController::is_type(type);
        }
...
#define YORDLE_META_DEF_PatchingViewController
#endif

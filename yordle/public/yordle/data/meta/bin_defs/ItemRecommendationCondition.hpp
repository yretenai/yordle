...
namespace yordle::data::meta {
    struct YORDLE_EXPORT ItemRecommendationCondition : public bin_class {
        explicit ItemRecommendationCondition(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 396544810u;
        }

        yordle::data::meta::bin_fnv_hash mItem = 0u;
        uint32_t mDisplayLimit = 0u;
        uint8_t mGroupId = 0u;
    };
}
#define YORDLE_META_DEF_ItemRecommendationCondition
#endif

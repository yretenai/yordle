...
yordle::data::meta::FadeToExplicitValueBehavior::FadeToExplicitValueBehavior(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::ITargeterFadeBehavior(prop) {
    if(prop == nullptr) {
        return;
    }

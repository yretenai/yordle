...
yordle::data::meta::ContextualConditionCharacterPlayingAnimation::ContextualConditionCharacterPlayingAnimation(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::ICharacterSubcondition(prop) {
    if(prop == nullptr) {
        return;
    }

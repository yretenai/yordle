...
yordle::data::meta::IntTableGet::IntTableGet(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IIntGet(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_Default != nullptr) {
        auto ptr_Default_opt = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::int32_prop>(ptr_Default->value);

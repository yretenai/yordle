...
yordle::data::meta::ContextualConditionHasItemFromVOGroup::ContextualConditionHasItemFromVOGroup(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IContextualCondition(prop) {
    if(prop == nullptr) {
        return;
    }

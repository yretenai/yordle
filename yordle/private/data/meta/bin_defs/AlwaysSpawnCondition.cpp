...
yordle::data::meta::AlwaysSpawnCondition::AlwaysSpawnCondition(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IVFXSpawnConditions(prop) {
    if(prop == nullptr) {
        return;
    }

...
#ifndef YORDLE_META_DEF_EffectAmmoElementData
#pragma once
...
namespace yordle::data::meta {
    struct YORDLE_EXPORT EffectAmmoElementData : public EffectElementData {
        explicit EffectAmmoElementData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3262156994u || EffectElementData::is_type(type);
        }
...
#define YORDLE_META_DEF_EffectAmmoElementData
#endif

...
#ifndef YORDLE_META_DEF_NotScriptCondition
#pragma once
...
#endif
    struct YORDLE_EXPORT NotScriptCondition : public IScriptCondition {
        explicit NotScriptCondition(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 2824201906u || IScriptCondition::is_type(type);
        }

        std::shared_ptr<yordle::data::meta::IScriptCondition> Condition {};
    };
}
#define YORDLE_META_DEF_NotScriptCondition
#endif

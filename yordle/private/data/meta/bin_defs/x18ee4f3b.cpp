...
yordle::data::meta::x18ee4f3b::x18ee4f3b(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::xe132f2d0(prop) {
    ...
    auto ptr_x2e1c1e9b = prop->cast_prop<yordle::data::prop::inline_structure_prop>(773594779u);
    if(ptr_x2e1c1e9b != nullptr) {
        x2e1c1e9b = yordle::data::meta::deserialize<yordle::data::meta::x94205387>(ptr_x2e1c1e9b, 2485146503u);
    }

    auto ptr_x8bab364f = prop->cast_prop<yordle::data::prop::bool_prop>(2343253583u);
    if(ptr_x8bab364f != nullptr) {
        x8bab364f = ptr_x8bab364f->value;
    }

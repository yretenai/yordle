...
yordle::data::meta::SyncedAnimationEventData::SyncedAnimationEventData(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::BaseEventData(prop) {
    if(prop == nullptr) {
        return;
    }

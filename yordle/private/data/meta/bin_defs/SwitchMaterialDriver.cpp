...
yordle::data::meta::SwitchMaterialDriver::SwitchMaterialDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::x995ca734(prop) {
    ...
    if(ptr_mElements != nullptr) {
        for(const auto &set_mElements_entry : ptr_mElements->value) {
            auto ptr_mElements_entry = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::inline_structure_prop>(set_mElements_entry);
            if(ptr_mElements_entry != nullptr) {
                mElements.emplace_back(yordle::data::meta::deserialize<yordle::data::meta::SwitchMaterialDriverElement>(ptr_mElements_entry, 1173409658u));
            }
        }
    }

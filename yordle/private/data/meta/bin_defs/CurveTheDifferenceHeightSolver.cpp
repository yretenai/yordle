...
yordle::data::meta::CurveTheDifferenceHeightSolver::CurveTheDifferenceHeightSolver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::HeightSolverType(prop) {
    if(prop == nullptr) {
        return;
    }

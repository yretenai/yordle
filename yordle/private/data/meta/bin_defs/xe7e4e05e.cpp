...
yordle::data::meta::xe7e4e05e::xe7e4e05e(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::x9a2769a4(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_values != nullptr) {
        for(const auto &set_values_entry : ptr_values->value) {
            auto ptr_values_entry = yordle::data::prop::empty_prop::cast_prop<yordle::data::prop::int32_prop>(set_values_entry);

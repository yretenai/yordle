...
yordle::data::meta::BuffStackingSettings::BuffStackingSettings(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    ...
    if(ptr_templateDefinition != nullptr) {
        for(const auto &set_templateDefinition_entry : ptr_templateDefinition->value) {
            ...
            if(ptr_templateDefinition_entry != nullptr) {
                templateDefinition.emplace_back(yordle::data::meta::deserialize<yordle::data::meta::BuffStackingTemplate>(ptr_templateDefinition_entry, 471801710u));
            }
        }
    }
}

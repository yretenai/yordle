...
yordle::data::meta::StaticMaterialPassDef::StaticMaterialPassDef(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::bin_class(prop) {
    if(prop == nullptr) {
        return;
    }
    auto ptr_shader = prop->cast_prop<yordle::data::prop::reference_prop>(895309160u);
    if(ptr_shader != nullptr) {
        shader = yordle::data::meta::bin_ref<yordle::data::meta::IShaderDef>(196890972u, ptr_shader->value);
    }

...
yordle::data::meta::MinMaterialDriver::MinMaterialDriver(const std::shared_ptr<yordle::data::prop::structure_prop> &prop) : yordle::data::meta::IDynamicMaterialDriver(prop) {
    if(prop == nullptr) {
        return;
    }

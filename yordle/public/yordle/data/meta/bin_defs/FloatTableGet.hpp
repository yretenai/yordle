...
#ifndef YORDLE_META_DEF_FloatTableGet
#pragma once
...
namespace yordle::data::meta {
    ...
    struct ScriptTable;
#endif
    struct YORDLE_EXPORT FloatTableGet : public IFloatGet {
        explicit FloatTableGet(const std::shared_ptr<yordle::data::prop::structure_prop> &prop);

        bool is_type(uint32_t type) override {
            return type == 3990037433u || IFloatGet::is_type(type);
        }
...
#define YORDLE_META_DEF_FloatTableGet
#endif
